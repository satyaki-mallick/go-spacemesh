...
func New(conf config.Config, p2p NetworkService, sign signing.Signer, obp orphanBlockProvider, rolacle Rolacle, beginLayer chan types.LayerID, logger log.Log) *Hare {
	h := new(Hare)
